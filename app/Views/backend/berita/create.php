...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0 fw-bold text-dark"><i class="bi bi-pencil me-2"></i> <?= esc($title) ?></h4>
...
<div class="card border-0 shadow-sm rounded-3">
    <div class="card-body p-4">
        ...
        <form action="<?= base_url('panel/berita/store') ?>" method="post">
            <?= csrf_field() ?>

            <div class="row">
                <div class="col-md-8 mb-3">
                    <label for="title" class="form-label fw-semibold">Judul Berita <span class="text-danger">*</span></label>
                    <input type="text" class="form-control <?= isset($errors['title']) ? 'is-invalid' : '' ?>" id="title" name="title" value="<?= old('title') ?>" placeholder="Masukkan judul yang menarik...">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control <?= isset($errors['excerpt']) ? 'is-invalid' : '' ?>" id="excerpt" name="excerpt" rows="2" placeholder="Teks singkat yang muncul di halaman depan website (Maks. 255 karakter)."><?= old('excerpt') ?></textarea>
                ...
                <div class="col-md-8 mb-4">
                    <label for="image_input" class="form-label fw-semibold">Gambar Cover (Thumbnail) <span class="text-danger">*</span></label>
            ...
            <div class="text-end">
                <button type="submit" id="btnSubmit" class="btn btn-primary" disabled><i class="bi bi-send me-1"></i> Simpan & Publikasikan</button>
            </div>
        </form>
    </div>
</div>
    ...
    $(document).ready(function() {
        ...
        $('#summernote').summernote({
            ...
            toolbar: [
                ...
                ['table', ['table']],
                ['insert', ['link', 'video']], // Fitur upload gambar dinonaktifkan agar DB tidak bengkak
                ['view', ['fullscreen', 'codeview', 'help']]
            ]
        });
    });

    // Script Kompresi Client-Side Gambar Cover
    document.getElementById('image_input').addEventListener('change', function(event) {
        ...
        reader.onload = function(e) {
            ...
            img.onload = function() {
                ...
                const MAX_SIZE = 1200; // Resolusi cover bisa sedikit lebih besar dari icon
                let width = img.width;
                ...
                let maxLength = 95000; // Maksimal ~70KB untuk cover berita
